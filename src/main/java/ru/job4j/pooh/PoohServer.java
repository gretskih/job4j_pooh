...
public class PoohServer {
                ...
                pool.execute(() -> {
                    try (OutputStream out = socket.getOutputStream();
                        ...
                        while (true) {
                            ...
                            addReceiverOrPublish(details[0], details[1], details[2], out);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    private void addReceiverOrPublish(String action, String name, String text, OutputStream out) {
